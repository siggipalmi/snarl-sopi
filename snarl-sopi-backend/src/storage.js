...
const stmts = {
  ...
  setProductImage: db.prepare(`UPDATE products SET imgUrl=@imgUrl, imageHasBackground=@imageHasBackground,
      weimiImgUrl=COALESCE(@weimiImgUrl, weimiImgUrl), imageNormalizedAt=@imageNormalizedAt, updatedAt=@updatedAt
...
const storage = {
  ...
  setProductImage(goodsId, { imgUrl, hasBackground, weimiImgUrl }) {

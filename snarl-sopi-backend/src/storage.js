...
const stmts = {
  ...
  upsertProduct: db.prepare(`INSERT INTO products
      (goodsId, customCode, name, salePriceIsk, vatRate, costPriceIsk, weightGrams, measurement, barcode, imgUrl, createdAt, updatedAt)
      VALUES (@goodsId, @customCode, @name, @salePriceIsk, @vatRate, @costPriceIsk, @weightGrams, @measurement, @barcode, @imgUrl, @createdAt, @updatedAt)
